  ...
  <div class="menu">
    ...
    >
      ...
      <a-sub-menu key="sub2">
        ...
        <a-menu-item key="21">Option 9</a-menu-item>
        <a-menu-item key="22">Option 10</a-menu-item>
        <a-sub-menu key="sub3" title="Submenu">
          <a-menu-item key="23">Option 11</a-menu-item>
          <a-menu-item key="24">Option 12</a-menu-item>
        </a-sub-menu>
      </a-sub-menu>
      <a-sub-menu key="sub2">
        <span slot="title">
